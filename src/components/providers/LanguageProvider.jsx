...
const translations = {
  he: {
    ...
    // A11y - Icon buttons & screen reader labels
    'a11y.close': 'סגור',
    'a11y.closeMenu': 'סגור תפריט',
    'a11y.openMenu': 'פתח תפריט',
    'a11y.moreOptions': 'עוד אפשרויות',
    'a11y.openSettings': 'הגדרות',
    'a11y.openNotifications': 'פתח התראות',
    'a11y.previousMonth': 'חודש קודם',
    'a11y.nextMonth': 'חודש הבא',
    'a11y.delete': 'מחק',
    'a11y.deleteProject': 'מחק פרויקט',
    'a11y.deleteRecording': 'מחק הקלטה',
    'a11y.deleteDocument': 'מחק מסמך',
    'a11y.deleteUser': 'הסר משתמש',
    'a11y.deleteItem': 'הסר פריט',
    'a11y.deleteTask': 'הסר משימה',
    'a11y.edit': 'ערוך',
    'a11y.editRecording': 'ערוך הקלטה',
    'a11y.view': 'צפייה',
    'a11y.download': 'הורד',
    'a11y.copyLink': 'העתק קישור',
    'a11y.remove': 'הסר',
    'a11y.removeFile': 'הסר קובץ',
    'a11y.previousStep': 'שלב קודם',
    'a11y.nextStep': 'שלב הבא',
    'a11y.pause': 'השהה',
    'a11y.play': 'הפעל',
    'a11y.stop': 'עצור',
    'a11y.expand': 'הרחב',
    'a11y.selectMode': 'מצב בחירה',
    'a11y.panMode': 'מצב גרירה',
    'a11y.undo': 'בטל',
    'a11y.redo': 'בצע שוב',
    'a11y.zoomOut': 'הקטן',
    'a11y.zoomIn': 'הגדל',
    'a11y.removeBackground': 'הסר תמונת רקע',
    'a11y.addToCalendar': 'הוסף ללוח שנה',
    'a11y.freeDrag': 'שחרר לגרירה חופשית',
    'a11y.toggleVisibility': 'הצג או הסתר',
    'a11y.toggleExpand': 'הרחב או כווץ',
    'a11y.backToList': 'החזר לרשימה',
    'a11y.lock': 'נעל',
    'a11y.unlock': 'בטל נעילה',
    'a11y.call': 'התקשר',
    'a11y.open': 'פתח',
    'a11y.scheduleFollowUp': 'תזמן מעקב',
    'a11y.previousWeek': 'שבוע קודם',
    'a11y.nextWeek': 'שבוע הבא',
    'a11y.previousDay': 'יום קודם',
    'a11y.nextDay': 'יום הבא',
    'a11y.addFolder': 'הוסף תיקייה',
    'a11y.addItem': 'הוסף פריט',
    'a11y.duplicate': 'שכפל',
    'a11y.cancel': 'ביטול',
    'a11y.exportImage': 'ייצא תמונה',
    'a11y.skipBack': 'הרץ אחורה',
    'a11y.skipForward': 'הרץ קדימה',
    'a11y.mute': 'השתק',
    'a11y.textColor': 'צבע טקסט',
    'a11y.highlight': 'צבע הדגשה',
    'a11y.opacity': 'שקיפות',
    'a11y.layerOrder': 'סדר שכבות',
    'a11y.align': 'יישור',
    'a11y.send': 'שלח',
    'a11y.rotateLeft': 'סובב שמאלה',
    'a11y.rotateRight': 'סובב ימינה',
    'a11y.flipH': 'הפוך אופקי',
    'a11y.flipV': 'הפוך אנכי',
    'a11y.bold': 'מודגש',
    'a11y.italic': 'נטוי',
    'a11y.underline': 'קו תחתון',
    'a11y.strikethrough': 'קו חוצה',
    'a11y.insertLink': 'הוסף קישור',
    'a11y.removeLink': 'הסר קישור',
    'a11y.copy': 'העתק',
    'a11y.heading1': 'כותרת 1',
    'a11y.heading2': 'כותרת 2',
    'a11y.heading3': 'כותרת 3',
    'a11y.bulletList': 'רשימת תבליטים',
    'a11y.numberedList': 'רשימה ממוספרת',
    'a11y.quote': 'ציטוט',
    'a11y.group': 'קבץ',
    'a11y.viewLink': 'צפה בקישור',
    'a11y.newProject': 'פרויקט חדש',
    'a11y.logHours': 'רישום שעות',
    'a11y.recordMeeting': 'הקלטת פגישה',
    'a11y.newInvoice': 'חשבונית חדשה',
    'a11y.addEvent': 'הוסף אירוע',
  ...
  en: {
    ...
    'a11y.deleteDocument': 'Delete document',
    'a11y.deleteUser': 'Remove user',
    'a11y.deleteItem': 'Remove item',
    'a11y.deleteTask': 'Remove task',
    'a11y.edit': 'Edit',
    'a11y.editRecording': 'Edit recording',
    'a11y.view': 'View',
    'a11y.download': 'Download',
    'a11y.copyLink': 'Copy link',
    'a11y.remove': 'Remove',
    'a11y.removeFile': 'Remove file',
    'a11y.previousStep': 'Previous step',
    'a11y.nextStep': 'Next step',
    'a11y.pause': 'Pause',
    'a11y.play': 'Play',
    'a11y.stop': 'Stop',
    'a11y.expand': 'Expand',
    'a11y.selectMode': 'Select mode',
    'a11y.panMode': 'Pan mode',
    'a11y.undo': 'Undo',
    'a11y.redo': 'Redo',
    'a11y.zoomOut': 'Zoom out',
    'a11y.zoomIn': 'Zoom in',
    'a11y.removeBackground': 'Remove background image',
    'a11y.addToCalendar': 'Add to calendar',
    'a11y.freeDrag': 'Free drag mode',
    'a11y.toggleVisibility': 'Toggle visibility',
    'a11y.toggleExpand': 'Toggle expand',
    'a11y.backToList': 'Back to list',
    'a11y.lock': 'Lock',
    'a11y.unlock': 'Unlock',
    'a11y.call': 'Call',
    'a11y.open': 'Open',
    'a11y.scheduleFollowUp': 'Schedule follow-up',
    'a11y.previousWeek': 'Previous week',
    'a11y.nextWeek': 'Next week',
    'a11y.previousDay': 'Previous day',
    'a11y.nextDay': 'Next day',
    'a11y.addFolder': 'Add folder',
    'a11y.addItem': 'Add item',
    'a11y.duplicate': 'Duplicate',
    'a11y.cancel': 'Cancel',
    'a11y.exportImage': 'Export image',
    'a11y.skipBack': 'Skip backward',
    'a11y.skipForward': 'Skip forward',
    'a11y.mute': 'Mute',
    'a11y.textColor': 'Text color',
    'a11y.highlight': 'Highlight color',
    'a11y.opacity': 'Opacity',
    'a11y.layerOrder': 'Layer order',
    'a11y.align': 'Align',
    'a11y.send': 'Send',
    'a11y.rotateLeft': 'Rotate left',
    'a11y.rotateRight': 'Rotate right',
    'a11y.flipH': 'Flip horizontal',
    'a11y.flipV': 'Flip vertical',
    'a11y.bold': 'Bold',
    'a11y.italic': 'Italic',
    'a11y.underline': 'Underline',
    'a11y.strikethrough': 'Strikethrough',
    'a11y.insertLink': 'Insert link',
    'a11y.removeLink': 'Remove link',
    'a11y.copy': 'Copy',
    'a11y.heading1': 'Heading 1',
    'a11y.heading2': 'Heading 2',
    'a11y.heading3': 'Heading 3',
    'a11y.bulletList': 'Bullet list',
    'a11y.numberedList': 'Numbered list',
    'a11y.quote': 'Quote',
    'a11y.group': 'Group',
    'a11y.viewLink': 'View link',
    'a11y.show': 'Show',
    'a11y.hide': 'Hide',
    'a11y.newProject': 'New project',
    'a11y.logHours': 'Log hours',
    'a11y.recordMeeting': 'Record meeting',
    'a11y.newInvoice': 'New invoice',
    'a11y.addEvent': 'Add event',
